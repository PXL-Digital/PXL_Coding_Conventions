...
- Gebruik PUT om een bestaande resource bij te werken.
...
- Geef de gewijzigde resource terug mee in de respons.

### **CC-05 HTTP Method: PATCH**

- Gebruik PATCH voor gedeeltelijke updates van een bestaande resource.
- Voeg **alleen de gewijzigde velden** toe aan het request in JSON-formaat.
- Geef een statuscode 200 terug voor een succesvolle update.
- Geef de gewijzigde resource terug mee in de respons.

### **CC-06 HTTP Method: DELETE**
...
### **CC-09 Authenticatie en Autorisatie**
